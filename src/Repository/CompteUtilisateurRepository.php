...
* @implements PasswordUpgraderInterface<CompteUtilisateur>
 *
 ...
 */
class CompteUtilisateurRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
